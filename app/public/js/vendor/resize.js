...
var resizeableImage = function(image_target) {
  ...
  var init = function(){
    ...
    var img = document.getElementById(image_target.id);
    var origWidth = img.clientWidth;
    var origHeight = img.clientHeight;
    var ratio = origHeight/origWidth;
    var width = window.innerWidth * 0.5;
    var height = height || width * ratio;
  ...
  var resizing = function(e) {
    ...
    if(width > min_width && height > min_height && width < max_width && height < max_height){
      ...
      console.log('resize constraint violated');
    }
  }

  var resizeImage = function(width, height) {
    var resizeTime = new Date();
    // resizeTime.setSeconds(resizeTime.getSeconds() - 0.2);
    // if (lastResizeAt !== null && lastResizeAt < resizeTime  ) {
    //   return;
    // }
    ...
    var origWidth = resize_canvas.width;
    var origHeight = resize_canvas.height;
    var ratio = origHeight/origWidth;
