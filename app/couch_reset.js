...
couch.createDB('auction', function(err, response) {
  var db = 'auction';
  couch.save(db, {_id: uuid.v4(), auction_name: 'Dragon Egg', start_bid: 50000, step: 200, image_path: 'dragon_egg.jpg', bid_count: 0}, function() {});
  couch.save(db, {_id: uuid.v4(), auction_name: 'Golden Hand', start_bid: 300, step: 12, image_path: 'golden_hand.jpg', bid_count: 0}, function() {});
});
